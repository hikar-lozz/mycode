...
def make_output_name(dat_path: Path) -> Path:
    """
    入力例:
        nearshield_proton_100umsource_t_let_proton.dat

    出力例:
        spectrum_nearshield__proton_100umsource_t_let_proton.csv
    """
...
def main(dat_file):
    ...
    # DataFrame の列名（RCF2, RCF5, RCF8）を格納するリスト
    columns = []
